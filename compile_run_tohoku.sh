...
do
    ...
    do
        ...
        command='mpiexec -n 4 bin/'$exe' -sections 1 -lbsplit -courant 0.95 -threads 1 -tout 120.0 -dmin 0 -dmax '$max_depth' -tmax 10.8e3 -fdispl '$fdispl' -fbath '$fbath' -xmloutput '$vtk' -stestpoints "545735.266126 62716.4740303,935356.566012 -817289.628677,1058466.21575 765077.767857" -output_dir '$output_dir
